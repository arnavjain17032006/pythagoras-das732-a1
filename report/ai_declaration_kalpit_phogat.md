...
**Specific Applications:**
- None (this assignment does not involve 3D modeling or generated visual assets)
...
**Core Logic & Authorship Statement:** I certify that the dataset selection, task-set design, choice of variables, and analytical framing for my task set reflect my own understanding of the assignment and the data. Furthermore, the analysis, conclusions, and technical evaluations presented in the report reflect my own understanding of the material. AI tools were used for supplemental code generation, report drafting, and editing as described above; I have reviewed the generated code and text and take responsibility for the accuracy and interpretation of the figures and findings attributed to my task set.
